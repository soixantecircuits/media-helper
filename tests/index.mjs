...
import * as mh from '../media-helper.js'
...
const base64 = fs.readFileSync(
  path.resolve(__dirname, './tests/assets/base64.txt'),
  {
    encoding: 'utf-8'
  }
)
const dataURL = fs.readFileSync(
  path.resolve(__dirname, './tests/assets/dataURL.txt'),
  {
    encoding: 'utf-8'
  }
)
const filepath = path.resolve(__dirname, './tests/assets/image.jpg')
const URL = 'https://unsplash.it/320/240'
